...
function CodeOfConduct() {
  ...
  useEffect(() => {
    ...
    if (token && user) {
      fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/employee-acknowledgements?user.id=${user.id}&Policy_Type=Employee Handbook`,
        {
          headers: {
  ...
  return (
    <div className="py-4">
      <h3 className="text-center py-3 title-text">Employee Handbook</h3>
      <div>
      ...
      {codeOfConduct ? (
        <div className="container px-md-5 py-3">
          <p className="text-center">
            You have acknowledged ZYCLYX Employee Handbook on{" "}
            <strong>
        ...
        <div className="container px-md-5 py-3">
          <div className="px-md-5">
            <p className="text-danger">
              <strong>
                Please read the Employee Handbook carefully to ensure that you
                understand the policy before signing this document.
              </strong>
            </p>
            ...
            <FormGroup check>
              <Label check>
                ...
                <p>
                  ...
                  and expectations of the Employee Handbook for employees at
                  ZYCLYX. I have received a copy of the document and agree to
